...
static void S_SoundList_f(void)
{
	...
	{
		if (known_sfx[i].needload)
			continue;

		sfxcache_t *sc = known_sfx[i].sc;
...
//		shm->buffer[4] = shm->buffer[5] = 0x7f;	// force a pop for debugging
	...
	ambient_sfx[AMBIENT_WATER] = S_ForName("ambience/water1.wav");
	ambient_sfx[AMBIENT_SKY] = S_ForName("ambience/wind2.wav");
